...
from .date_range import parse_date_range as _parse_date_range
...
class DashboardEngine:
    ...
    def parse_date_range(self, date_range_str: Optional[str]) -> Tuple[Optional[date], Optional[date]]:
        ...
        Delegates to the shared parser in `date_range.py` (also used directly by
        the trades-list route) so the grammar is defined in exactly one place.
        """
        return _parse_date_range(date_range_str)
